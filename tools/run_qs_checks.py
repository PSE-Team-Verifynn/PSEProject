import json
from qs_common import GUI_OUT_DIR, PROFILING_OUT_DIR, QUALITY_OUT_DIR, TEST_RESULTS_DIR, ensure_output_dir, write_json
...
def main() -> None:
    ensure_output_dir(TEST_RESULTS_DIR)
    ...
    write_json(TEST_RESULTS_DIR / "qs_summary.json", summary)

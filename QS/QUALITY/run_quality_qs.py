...
def build_quality_cases() -> list[dict]:
    ...
    cases = [
        ...
        },
        {
            ...
            "network": ROOT / "TestFiles" / "NN1.onnx",
            "network_name": "NN1",
            "bounds": ROOT / "TestFiles" / "B2.vnnlib",
            "bounds_label": "B2.vnnlib",
            "algorithm": algorithm,
            "selected_neurons": [(0, 0), (0, 1)],
            "samples": 2000,
        },
        {
            "case": "NN1_UnitBox_BoxIBP",
            "network": ROOT / "TestFiles" / "NN1.onnx",
            "network_name": "NN1",
        ...
        {
            "case": "IR11_1_B1_BoxIBP",
            "network": ROOT / "TestFiles" / "IR11_1_gemm.onnx",
            "network_name": "IR11_1",
            "bounds": ROOT / "TestFiles" / "B1.csv",
            "bounds_label": "B1.csv",
            "algorithm": algorithm,
        ...
        {
            "case": "IR11_2_UnitBox_BoxIBP",
            "network": ROOT / "TestFiles" / "IR11_2_gemm.onnx",
            "network_name": "IR11_2",
            "default_bounds": (0.0, 1.0),
            "bounds_label": "[0,1]^n",
            "algorithm": algorithm,
            "selected_neurons": [(1, 0), (1, 1)],
            "samples": 1000,
        },
        {
            "case": "IR11_2_Symmetric_BoxIBP",
            "network": ROOT / "TestFiles" / "IR11_2_gemm.onnx",
            "network_name": "IR11_2",
        ...
        {
            "case": "IR11_2_Narrow_BoxIBP",
            "network": ROOT / "TestFiles" / "IR11_2_gemm.onnx",
            "network_name": "IR11_2",
            "default_bounds": (0.25, 0.75),
            "bounds_label": "[0.25,0.75]^n",
            "algorithm": algorithm,
            "selected_neurons": [(1, 0), (1, 1)],
            "samples": 1000,
        },
    ...
    for case in cases:
        case["plot_label"] = f"{case['network_name']}\n{case['bounds_label']}"
    return cases
...
def run_quality_checks() -> list[dict]:
    ...
    for case in build_quality_cases():
        ...
        polygon = compute_polygon([(float(low), float(high)) for low, high in computed_bounds], directions)
        ...
        write_json(QUALITY_CASES_OUT_DIR / f"{case['case']}.json", detail_payload)
        write_quality_case_plot(case["case"], sample_points, polygon, sample_hull, width_rows)
...
def main() -> None:
    ...
    ensure_output_dir(QUALITY_CASES_OUT_DIR)

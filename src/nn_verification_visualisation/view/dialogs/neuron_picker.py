...
from PySide6.QtWidgets import (QWidget, QSplitter, QLabel, QHBoxLayout,
                               QVBoxLayout, QComboBox, QSpinBox, QPushButton, QLayout, QGroupBox, QScrollArea)
...
class NeuronPicker(DialogBase):
    ...
    def __get_side_bar_content(self) -> QVBoxLayout:
        ...
        # --- Bounds Display ---
        self.bounds_display_group = BoundsDisplayWidget("Bounds", min_height=200, max_height=260)
        input_count = 0
        if Storage().networks:
